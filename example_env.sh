export KC_DATABASE_PASSWORD="koira"  # pragma: allowlist secret
...
export KC_ADMIN_PASSWORD="marsu"  # pragma: allowlist secret
...
export KC_PROFILEROOT_UUID="4f88fe8c-ffa5-4ae4-97c9-3831a500d502"  # use uuidgen -r in production
export KC_HTTPS_KEY_STORE_PASSWORD="chinchilla"  # pragma: allowlist secret
export KC_HTTPS_TRUST_STORE_PASSWORD="iguaani"  # pragma: allowlist secret
